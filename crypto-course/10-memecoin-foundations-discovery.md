...
**How liquidity affects price** is the same thin-liquidity mechanic already walked through in §3's "why they pump" and "why they crash" paragraphs and formalized in Module 3 — restated here only to flag it explicitly as its own checklist item: liquidity, not market cap or narrative strength, is what actually determines how violently a given amount of buying or selling moves price.

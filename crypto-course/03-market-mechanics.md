...
**Market capitalization (market cap)** is calculated as price × circulating supply, and it answers one specific question: what is the market, right now, collectively valuing every circulating unit of this asset at? That's it. It is a snapshot valuation multiplied out from the last traded price: no one wrote a check for the full market cap, nowhere is that capital actually sitting inside the project, and it isn't what you'd receive if every holder tried to sell simultaneously — since price is set by the last trade, a wave of selling crashes the price on the way down, so the "market cap" evaporates precisely because people try to realize it. This is a mechanical fact, not a pessimistic take, and one that becomes dangerous to ignore on any asset where liquidity is thin.

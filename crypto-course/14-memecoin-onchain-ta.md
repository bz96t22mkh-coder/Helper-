...
**The practical rule that ties all of this together is a spectrum, not a switch** — reliability doesn't suddenly "turn on" at some fixed holder count; it's precisely the gradual, §4-described process of building real market memory, made explicit and checkable via the three-question test above instead of left as a gut feeling.

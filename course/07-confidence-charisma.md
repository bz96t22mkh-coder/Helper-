...
**Length:** 13 days. **Goal:** genuine confidence built on real evidence — not fake bravado, and not just "feeling ready."
...
| Min | Do |
|---|---|
| 15 | Baseline: rate your confidence (1–5) starting conversations, disagreeing with someone, handling a mistake publicly, being told no. |
| 20 | Write 10 concrete things you've done that took real nerve or competence, however small. |
| 10 | Reread the list before one real interaction today. |
| 15 | Which item surprised you when you saw it written down? |
...
|---|---|
| 5 | Warm-up. |
| 25 | In a real conversation, hold eye contact through full sentences at least 5 times without glancing away mid-thought. |
| 20 | Where did you want to look away, and what were you feeling right then? |
| 10 | Reflection. |
...
| Min | Do |
|---|---|
| 5 | Reread evidence list. |
| 30 | Real interaction combining presence, steady voice, sustained eye contact. Report specifics. |
...
|---|---|
| 5 | Warm-up. |
| 25 | In a real conversation, let your genuine reaction show more than you normally would — don't flatten it. |
| 20 | What did you hold back before that you let through today, and what happened? |
| 10 | Reflection. |
...
|---|---|
| 5 | Reread evidence list. |
| 30 | Climb to ladder rung 4. Report handling of discomfort, any mistake or rejection, and how engaged you were. |
| 15 | Rep on weakest element. |
...
|---|---|
| 5 | Warm-up. |
| 30 | Real conversation deliberately combining presence, voice, eye contact, genuine engagement, and clear delivery all at once. |
| 15 | What did combining everything feel like vs. practicing pieces separately? |
| 10 | Reflection. |

### Day 12 — Your Hardest Rung

| Min | Do |
|---|---|
| 5 | Plan today's hardest ladder rung. |
| 40 | Do it for real. |
| 15 | Full account: what you felt beforehand, what you did, what happened, how you feel now. |
...
|---|---|
| 5 | Reread evidence list. |
| 40 | Submit your top-rung result plus the 4 confidence self-ratings from Day 1, with specific evidence for each. |
| 15 | Compare all 4 ratings to Day 1 — where's the biggest shift? |

**Mastery bar:** you hold presence, voice, and eye contact reliably, and recover from mistakes without spiraling. If not yet, rebuild a slightly easier discomfort ladder and repeat the presence/voice/eye-contact drills.

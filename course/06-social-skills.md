...
**Length:** 15 days. **Goal:** start conversations, keep them going, and stay comfortable when they get awkward.
...
| Min | Do |
|---|---|
| 5 | Recall yesterday's follow-ups. |
| 25 | In a real conversation, note 2 engagement or disengagement signals and how you responded. |
| 30 | What's a cue you've probably been missing regularly? |

### Day 5 — Checkpoint

| Min | Do |
|---|---|
| 5 | Warm-up: rehearse an opener. |
| 30 | Real conversation using an opener, open body language, and a follow-up question. Report specifics. |
| 15 | Rep on weakest element. |
| 10 | Progress vs. Day 1. |

### Day 6 — Extending the Conversation

| Min | Do |
|---|---|
| 5 | Warm-up. |
| 35 | Aim for one real conversation lasting 5+ minutes, combining openers, follow-ups, and reading cues. |
| 20 | Where did momentum drop, and what could have kept it going? |
...
|---|---|
| 5 | Warm-up. |
| 25 | In a real conversation, ask "why" or "what was that like" at least twice instead of redirecting to yourself. |
| 20 | Did the other person visibly open up more? |
| 10 | Reflection. |
...
### Day 9 — Making the Other Person Comfortable
...
|---|---|
| 5 | Warm-up. |
| 30 | Real conversation, 4+ minutes, using rapport-building, silence tolerance, and comfort-focus. Report specifics. |
| 15 | Rep on weakest element. |
| 10 | Progress vs. Day 5. |

### Day 11 — Talking to Strangers

| Min | Do |
|---|---|
| 5 | Warm-up. |
| 35 | Initiate 2 brief, low-pressure exchanges with strangers today. |
| 15 | Compare the two — what made one easier or harder? |
| 5 | Reflection. |
...
|---|---|
| 5 | Warm-up. |
| 25 | In 2 real conversations with different people, deliberately match their style — brief vs. detailed, small-talk vs. deep. |
| 20 | What did you consciously adjust for each person? |
| 10 | Reflection. |
...
|---|---|
| 5 | Warm-up. |
| 25 | Recall a real past social rejection or awkward moment. Name the emotion, understand it, reframe it. |
| 20 | What would you do differently if it happened again today? |
| 10 | Reflection. |
...
| Min | Do |
|---|---|
| 5 | Plan today's real conversation with someone new or a stranger. |
| 40 | Have it — an opener, 2+ follow-ups, one tolerated silence, reading and adapting to at least one cue. Report in full. |
| 15 | Compare to Day 1's comfort rating — where are you now? |

**Mastery bar:** you reliably start and sustain conversations with strangers and tolerate silence without panicking. If not yet, repeat sustaining-conversations or silence-tolerance drills with new real interactions.

...
**Length:** 10 days. **Goal:** a real system that protects this course, trading study, and everything else from just evaporating into "whatever felt urgent today."
...
| Min | Do |
|---|---|
| 30 | Run one real 30-minute uninterrupted block. Log every moment your focus broke. |
| 15 | For each break, was it internal (mind wandering) or external (a notification)? |
| 15 | Pick one environment change for tomorrow based on what broke you. |
...
| Min | Do |
|---|---|
| 15 | Name a task you've been avoiding. Identify the actual feeling under it — boring, unclear, scary? |
| 20 | Break it down until you have a first slice small enough to start in under 2 minutes. |
| 15 | Do that first slice, right now. |
| 10 | Did starting reduce the resistance? |
...
| Min | Do |
|---|---|
| 20 | Pick one real 1–3 month goal. Break it into this month's outcome, then this week's. |
| 20 | Adjust this week's schedule so it visibly serves that outcome. |
| 20 | Could you have explained the connection between today's schedule and a real goal before this exercise? |
...
### Day 10 — Run the Whole System

| Min | Do |
|---|---|
| 30 | Finalize your full system: schedule, habit cues, weekly review template, one energy-based fix. Send it to me. |
| 15 | Start it today. Set the exact day/time of your first weekly review. |
| 15 | Rate your confidence (1–5) this survives a genuinely busy week, and why. |

**Mastery bar:** the schedule survives a bad week without collapsing, and the weekly review actually happens without you being reminded. This section stays in light maintenance after this — the weekly review keeps running every week from here on.
